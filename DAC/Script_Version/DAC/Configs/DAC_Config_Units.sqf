...
// RHS - MSV
  case 4:
  {
    _Unit_Pool_S = ["rhs_msv_armoredcrew","rhs_msv_officer_armored","rhs_msv_rifleman","rhs_msv_rifleman","rhs_msv_grenadier","rhs_msv_grenadier","rhs_msv_at","rhs_msv_at","rhs_msv_medic","rhs_msv_aa","rhs_msv_engineer","rhs_msv_rifleman","rhs_msv_rifleman","rhs_msv_at","rhs_msv_at","rhs_msv_rifleman","rhs_msv_officer_armored","rhs_msv_officer_armored"];
    _Unit_Pool_V = ["rhs_tigr_msv","RHS_UAZ_MSV_01","rhs_gaz66_msv","rhs_gaz66o_msv","RHS_Ural_MSV_01"];
    _Unit_Pool_T = ["rhs_btr60_msv","rhs_btr70_msv","rhs_btr80_msv","rhs_btr80a_msv","rhs_bmp1_msv","rhs_bmp1d_msv","rhs_bmp1k_msv"];
	_Unit_Pool_A = [];
  };
